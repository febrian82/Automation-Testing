...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InternationalTransfer/Amount'), findTestData('Negative International').getValue(
        'Amount', 18), FailureHandling.CONTINUE_ON_FAILURE)
...
CustomKeywords.'utils.VerifyResultMessage.verifyErrorMessageContains'(findTestData('Negative International').getValue('ErrorMessage', 
        18))
