...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-011-N/Step1verify-1-count-0.png')
...
'step 3.0: Enter value with Test Data Request column: data row: 3 in the t-select-city field'
...
'verify 3.0 count 1: -t-city-option will be not present'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-011-N/Step3.0verify-3.0-count-1.png')
