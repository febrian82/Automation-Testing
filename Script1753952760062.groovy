...
CustomKeywords.'keys.CheckorUncheck.CheckUsingCustomKeyword'(findTestObject('FrontEnd/TM_InHouseTransfer/button_MultiCurr'))

WebUI.setText(findTestObject('FrontEnd/TM_InHouseTransfer/treasury'), findTestData('Negative Inhouse').getValue('TIcket Number', 
        15), FailureHandling.STOP_ON_FAILURE)
