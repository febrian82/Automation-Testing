...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/treasury'), findTestData('Negative Inhouse').getValue(
        'TIcket Number', 19), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('FrontEnd/Negative Inhouse/benef_radiobtn'), FailureHandling.STOP_ON_FAILURE)
