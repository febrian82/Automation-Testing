...
WebUI.callTestCase(findTestCase('FrontEnd/CU - Single Billing G3/Step Group/Step Group - accessSingleBillingG3CorpSingle'), 
...
WebUI.callTestCase(findTestCase('FrontEnd/CU - Single Billing G3/Step Group/Step Group - addSingleBilling'), [:], FailureHandling.STOP_ON_FAILURE)

//No verification required
'step 3: Click on btn_Immediate'
WebUI.click(findTestObject('FrontEnd/CU - SingleBilling - GenerateBillingID_Reg/btn_Immediate'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('FrontEnd/CU - SingleBilling - GenerateBillingID_Reg/btn_Yes'), FailureHandling.STOP_ON_FAILURE)

'step 7: Click on btn_Yes'
WebUI.click(findTestObject('FrontEnd/CU - SingleBilling - GenerateBillingID_Reg/btn_Yes'), FailureHandling.STOP_ON_FAILURE)
