...
'step 2.0: Step Group - CreateChequeBookRequestCourier Step Group (Reusable Group) with test data: Test Data AccountGlobal, account_no: no_name_currency row: 1, AND Test Data BranchGlobal city: city row: 1; AND Test Data LabelGlobal type: B_Label row 11; AND Test Data Request quantity: quantity row: 2, address: data row: 12, postcode: data row: 7, object_account: object_id row: 3, object_city: object_id row: 1'
WebUI.callTestCase(findTestCase('Test Cases/FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Step Group/Step Group - CreateChequeBookRequestPickUp'), 
    [('account_no') : findTestData('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Test Data Request').getValue(
            'data', 14), ('city') : findTestData('FrontEnd/Test Data Global/Test Data BranchGlobal').getValue('city', 3)
        , ('branch') : findTestData('FrontEnd/Test Data Global/Test Data BranchGlobal').getValue('branch', 3), ('type') : findTestData(
            ...
            'object_id', 2), ('account_no_full') : findTestData('FrontEnd/Test Data Global/Test Data AccountGlobal').getValue(
            'nocurrencyname', 1)], FailureHandling.STOP_ON_FAILURE)
...
//No verification required
'step 10.0: PendingTaskCURejectDetail Step Group (Reusable Group) with test data: Test Data CredentialGlobal, corp: corp row: 22, user: user row: 22, pass: pass row: 22; AND with parameter: trxId: trxId'
WebUI.callTestCase(findTestCase('Test Cases/FrontEnd/Step Group (Reusable Group)/PendingTaskCURejectDetail'), [('corp') : findTestData(
            'Data Files/FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue('corp', 22), ('user') : findTestData(
            'Data Files/FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue('user', 22), ('pass') : findTestData(
            'Data Files/FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue('pass', 22), ('trxId') : trxId], 
    FailureHandling.STOP_ON_FAILURE)
