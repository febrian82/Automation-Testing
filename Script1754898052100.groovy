...
WebUI.selectOptionByValue(findTestObject('FrontEnd/Negative International/currency'), findTestData('Negative International').getValue(
        'Amount Curr', 11), false)

WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InternationalTransfer/Amount'), 'seratus', FailureHandling.CONTINUE_ON_FAILURE)
