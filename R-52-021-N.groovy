...
// updated step 1 Click on t-radio-delivery_type-PICK_UP_AT_BRANCH
'precondition'
...
'step 1: Click on t-radio-delivery_type-PICK_UP_AT_BRANCH'
...
'verify 1 count 1: t-radio-delivery_type-PICK_UP_AT_BRANCH will be checked'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-021-N/Step1verify-1-count-0.png')
...
'step 3.0: Enter value with test data column: city row: 1 in the t-select-city field'
...
//No verification required
'step 4.0: Use custom keyword handleWebTable.HTMLTableHelper_FO.selectItemonDropdown with input Test Data Request column: object_id row: 1, Test Data BranchGlobal column: city row: 1'
...
'verify 4.0 count 1: -t-select-city-trigger : Test Data BranchGlobal, column: city row: 1'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-021-N/Step4.0verify-4.0-count-1.png')

'step 5.0: Click on t-select-pick_up_at_branch-trigger'
WebUI.click(findTestObject('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/t-select-pick_up_at_branch-trigger'), 
    FailureHandling.STOP_ON_FAILURE)

//No verification required
'step 6.0: Enter value with test data column: data row: 3 in the t-select-branch field'
...
'verify 6.0 count 1: -t-pick_up_at_branch-option will be not displayed'
WebUI.verifyElementNotPresent(findTestObject('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/t-pick_up_at_branch-option'), 
    0)

CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-021-N/Step6.0verify-6.0-count-1.png')
