...
WebUI.setText(findTestObject('FrontEnd/Negative Inhouse/account_txtbx'), findTestData('Negative Inhouse').getValue('AccountNo', 
        17), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/treasury'), '20070392000612', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('FrontEnd/TM_InHouseTransfer/trxamount'), '5', FailureHandling.STOP_ON_FAILURE)
