...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-005-P-Step1.png')
...
'verify 4 count 1: btn_payeeList'
...
'verify 4 count 3: Click on droplist_payee'
...
'step 6: Enter value  in the Search_droplist_payee field'
WebUI.setText(findTestObject('FrontEnd/CU - Single Payment or Purchase/search_payee'), findTestData('FrontEnd/All Test Data/CU - Single Payment or Purchase/Test Data Single Payment').getValue(
        'payee', 4), FailureHandling.STOP_ON_FAILURE)
...
'verify 7 count 1: textbox_accountDescPayee'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-005-P-Step9.png')
...
'step 10: Click pn datepicklist_expiredOn'
...
'step 11: Click on checkboc_TnC'
WebUI.click(findTestObject('FrontEnd/CU - Single Payment or Purchase/checkbox_TnC'))

CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-005-P-Step11.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-005-P-Step18.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-005-P-Step19.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-005-P-Step22.png')
