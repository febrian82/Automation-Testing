...
WebUI.callTestCase(findTestCase('FrontEnd/CU - Single Billing G3/Step Group/Step Group - newTaxUSD'), [:], FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-41-001-P-Step13.png')
