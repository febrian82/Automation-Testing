...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InternationalTransfer/Amount'), findTestData('Negative International').getValue(
        'Amount', 5), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('FrontEnd/TM_InternationalTransfer/textbox_CorespondentBank'), findTestData('Negative International').getValue(
        'Corespondent Bank', 5), FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'webCalendar.webCalendar.customizedNextDate'(findTestData('Negative International').getValue('NextDate FowardValue', 
        5))
...
CustomKeywords.'customKeywords.AlertKeywords.verifyAlertText'(findTestData('Negative International').getValue('ErrorMessage', 
        5))
