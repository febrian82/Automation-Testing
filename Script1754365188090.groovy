...
WebUI.setText(findTestObject('FrontEnd/TM_InHouseTransfer/trxamount'), '9000000000', FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/OAbutton'), FailureHandling.STOP_ON_FAILURE)

CustomKeywords.'utils.PopupAccountSelector.selectAccountFromPopup'('1000509463')
