...
WebUI.callTestCase(findTestCase('Test Cases/FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Step Group/Step Group - CreateChequeBookRequestPickUp'), 
    [('account_no') : findTestData('FrontEnd/Test Data Global/Test Data AccountGlobal').getValue('account_no', 1), ('account_no_full') : findTestData(
            ...
            'Data Files/FrontEnd/Test Data Global/Test Data LabelGlobal').getValue('B_Label', 61), ('quantity') : findTestData(
            ...
            'object_id', 1), ('object_quantity') : findTestData('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Test Data Request').getValue(
            'object_id', 4), ('object_branch') : findTestData('Data Files/FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Test Data Request').getValue(
            'object_id', 2), ('postcode') : findTestData('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Test Data Request').getValue(
            'data', 7), ('address') : findTestData('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Test Data Request').getValue(
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step2.0.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step3.0.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step3.0verify-3.0-count-1.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step4.0.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step5.0.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step5.0verify-5.0-count-1.png')
...
WebUI.callTestCase(findTestCase('FrontEnd/Step Group (Reusable Group)/CompanyFinancialDetail'), [('corp') : findTestData(
            ...
            18), ('userName') : findTestData('FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue('user', 18)
        , ('menuName') : findTestData('FrontEnd/Test Data Global/Test Data MenuProductGlobal').getValue('Menu', 52), ('activityType') : GlobalVariable.Create
...
//No verification required
'step 9.0: PendingTaskCURejectListing Step Group (Reusable Group) with test data: Test Data CredentialGlobal, corp: corp row: 23, user: user row: 23, pass: pass row: 23, with parameter: trxId: trxId'
WebUI.callTestCase(findTestCase('FrontEnd/Step Group (Reusable Group)/PendingTaskCURejectListing'), [('corp') : findTestData(
...
'verify 9.0 count 1: Use custom keyword handleWebTable.HTMLTableHelper_FO.verifyListOnTableContainsSpecificValue with input [trxId; Test Data MessageGlobal column: Message row: 9]'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step9.0verify-9.0-count-1.png')

'step 10.0: Logout_FO Step Group (Reusable Group)'
WebUI.callTestCase(findTestCase('Test Cases/FrontEnd/Step Group (Reusable Group)/Logout_FO'), [:], FailureHandling.STOP_ON_FAILURE)

//No verification required
'step 11.0: TransactionStatusDetailCU Step Group (Reusable Group) with test data: Test Data CredentialGlobal, corp: corp row: 18, user: user row: 18, pass: pass row: 18, with parameter trxId: trxId'
...
'verify 11.0 count 1: Use custom keyword handleWebTable.HTMLTableHelper.verifyListOnTableContainsSpecificValue with input [docNo; Test Data CredentialGlobal column: user row: 22; Test Data LabelGlobal column: S_Label row: 72; Test Data LabelGlobal column: R_Label row: 37]'
CustomKeywords.'handleWebTable.HTMLTableHelper_FO.verifyListOnTableContainsSpecificValue'([docNo, findTestData('FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue(
            'user', 22), findTestData('FrontEnd/Test Data Global/Test Data LabelGlobal').getValue('S_Label', 72), findTestData(
            'FrontEnd/Test Data Global/Test Data LabelGlobal').getValue('R_Label', 37)])

CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-036-P/Step11.0verify-11.0-count-1.png')

'step 12.0: Logout_FO Step Group (Reusable Group)'
WebUI.callTestCase(findTestCase('Test Cases/FrontEnd/Step Group (Reusable Group)/Logout_FO'), [:], FailureHandling.STOP_ON_FAILURE)

//No verification required
'step 13.0: CompanyFinanciaDetail Step Group (Reusable Group) with test data: Test Data CredentialGlobal, corp: corp row: 18, user: user row: 18, pass: pass row: 18, activityBy: user row: 22; AND Test Data MenuProductGlobal column: Menu row: 52, with parameter activityType: GlobalVariable.Reject, with parameter trxId: trxId'
WebUI.callTestCase(findTestCase('FrontEnd/Step Group (Reusable Group)/CompanyFinancialDetail'), [('corp') : findTestData(
            'FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue('corp', 18), ('user') : findTestData('FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue(
            'user', 18), ('pass') : findTestData('FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue('pass', 
            18), ('userName') : findTestData('FrontEnd/Test Data Global/Test Data CredentialGlobal').getValue('user', 22)
        , ('menuName') : findTestData('FrontEnd/Test Data Global/Test Data MenuProductGlobal').getValue('Menu', 52), ('activityType') : GlobalVariable.Reject
        , ('trxId') : trxId], FailureHandling.STOP_ON_FAILURE)
