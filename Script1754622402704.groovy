...
WebUI.setText(findTestObject('FrontEnd/Negative Inhouse/account_txtbx'), '1000094661', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/treasury'), findTestData('Negative Inhouse').getValue(
        'TIcket Number', 16), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/thirdPartyAcc'), '1000034146', FailureHandling.STOP_ON_FAILURE)
