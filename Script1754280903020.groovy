...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/treasury'), '20070392000515', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('FrontEnd/TM_InHouseTransfer/trxamount'), '150000000', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/thirdPartyAcc'), findTestData('Negative Inhouse').getValue(
        'AccountNo', 13), FailureHandling.STOP_ON_FAILURE)
