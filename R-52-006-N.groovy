...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-006-N/Step1.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-006-N/Step2.0.png')
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-006-N/Step3.0.png')

//No verification required
'step 4.0: Enter value with test data column: quantity row: 1 in the t-inputQuantity field'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-006-N/Step4.0.png')

//No verification required
'step 5.0: Click on t-radio-deliveryMethod-1'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-006-N/Step5.0.png')

//No verification required
'step 6.0: Click on t-WorkflowAction-confirm'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-006-N/Step6.0.png')

'verify 6 count 1: -t-select-city-error : Test Data MessageGlobal, column: Message row: 6'
WebUI.verifyElementText(findTestObject('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/t-select-city-error'), 
    findTestData('Data Files/FrontEnd/Test Data Global/Test Data MessageGlobal').getValue('Message', 6))

CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-006-N/Step6verify-6-count-1.png')
