...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-004-P-Step1.png')
...
WebUI.setText(findTestObject('FrontEnd/CU - Single Payment or Purchase/search_institutCat'), findTestData('FrontEnd/All Test Data/CU - Single Payment or Purchase/Test Data Single Payment').getValue(
        'institutCat', 2), FailureHandling.STOP_ON_FAILURE)
...
'step 9: Click on droplist_institution_'
WebUI.click(findTestObject('FrontEnd/CU - Single Payment or Purchase/droplist_institution'), FailureHandling.STOP_ON_FAILURE)

'step 10: Enter value in the droplist_institution_ field'
WebUI.setText(findTestObject('FrontEnd/CU - Single Payment or Purchase/search_institutCat'), findTestData('FrontEnd/All Test Data/CU - Single Payment or Purchase/Test Data Single Payment').getValue(
        'institut', 2), FailureHandling.STOP_ON_FAILURE)
...
'step 12: Enter value in the dtextbox_idPel field'
CustomKeywords.'keys.SetTextHandler.handleInput'(findTestObject('FrontEnd/CU - Single Payment or Purchase/textbox_idPel'), 
    findTestData('FrontEnd/All Test Data/CU - Single Billing G3/New Test Data').getValue('idPel', 2))

'step 13: Click on textbox_idPel'
not_run: WebUI.click(findTestObject('FrontEnd/CU - Single Payment or Purchase/textbox_idPel'), FailureHandling.STOP_ON_FAILURE)

'step 14:  Enter value in the dtextbox_idPel field'
not_run: WebUI.setText(findTestObject('FrontEnd/CU - Single Payment or Purchase/textbox_idPel'), findTestData('FrontEnd/All Test Data/CU - Single Payment or Purchase/Test Data Single Payment').getValue(
        'idPel', 2))

'verify 14 count 1: textbox_accountDescPayee'
WebUI.verifyElementVisible(findTestObject('FrontEnd/CU - Single Payment or Purchase/textbox_accountDescPayee'))

'step 15: Enter value  in the textbox_accountDescPayee field'
...
'verify 15 count 1: -btn_immediate'
...
'verify 15 count 2: -btn_specificDate'
...
'verify 16 count 2: -droplist_session'
...
'verify 20 count 1: checkbox_TnC'
...
'verify 21 count 2: -button_continue'
...
'verify 26 count 1: btn_back'
WebUI.verifyElementVisible(findTestObject('FrontEnd/CU - Single Payment or Purchase/btn_back'))

'step 27: Click on button_SubmitConfirmation'
WebUI.click(findTestObject('FrontEnd/CU - Single Payment or Purchase/btn_submit'), FailureHandling.OPTIONAL)

'step 28: Click on button_SubmitConfirmation popup'
WebUI.click(findTestObject('FrontEnd/CU - Balance Transfer - Corp Single/button_popUpSubmit'), FailureHandling.OPTIONAL)

CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-004-P-Step28.png')

'step 29: Use custom keyword textProcessor.processText.removeText with input Reference No , object: label_ReferenceNo then assign into variable: refNo'
...
CustomKeywords.'get.ScreenCapture.getEntirePage'('C-51-004-P-Step29.png')
...
//No verification required
'step 32: accessTransactionStatusCorpByRefNo Step Group (Reusable Group) with parameter refNo: refNo'
...
'step 34: LoginFO Step Group (Reusable Group) with test data: Test Data UserGlobal, corporateID: corp row: 5, username: user row: 5, password: pass row: 5'
WebUI.callTestCase(findTestCase('Test Cases/FrontEnd/Step Group (Reusable Group)/LoginFO'), [('corporateID') : findTestData(
            'Data Files/FrontEnd/Test Data Global/Test Data UserGlobal').getValue('corp', 20), ('username') : findTestData(
            'Data Files/FrontEnd/Test Data Global/Test Data UserGlobal').getValue('user', 20), ('password') : findTestData(
            'Data Files/FrontEnd/Test Data Global/Test Data UserGlobal').getValue('pass', 5)], FailureHandling.STOP_ON_FAILURE)
...
//No verification required
'step 35: accessCorporateFinancial Step Group (Reusable Group) with test data: Test Data MenuGlobal, menuName: Menu row: 4'
...
//No verification required
'step 36: Logout Step Group (Reusable Group)'
WebUI.callTestCase(findTestCase('Test Cases/FrontEnd/Step Group (Reusable Group)/Logout'), [:], FailureHandling.STOP_ON_FAILURE)
