...
//No verification required
'step 6.0: Enter value with test data column: city row: 4 in the t-select-city field'
...
//No verification required
'step 7.0: Use custom keyword handleWebTable.HTMLTableHelper_FO.selectItemonDropdown with input Test Data Request column: object_id row: 1, Test Data BranchGlobal column: city row: 4'
CustomKeywords.'handleWebTable.HTMLTableHelper_FO.selectItemonDropdown'(findTestData('Data Files/FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Test Data Request').getValue(
        'object_id', 1), findTestData('Data Files/FrontEnd/FO_CA_CU/Test Data Global/Test Data BranchGlobal').getValue('city', 
        3))

//No verification required
//failed to generate step 8.0
//No verification required
'step 9.0: Click on t-select-branch'
WebUI.click(findTestObject('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/t-select-branch'), 
    FailureHandling.STOP_ON_FAILURE)

//No verification required
'step 10.0: Enter value with Test Data BranchGlobal column: branch row: 4in the t-select-branch field'
...
//No verification required
'step 11.0: Use custom keyword handleWebTable.HTMLTableHelper_FO.selectItemonDropdown with input Test Data Request column: object_id row: 2, Test Data BranchGlobal column: branch row: 4'
CustomKeywords.'handleWebTable.HTMLTableHelper_FO.selectItemonDropdown'(findTestData('Data Files/FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/Test Data Request').getValue(
...
'verify 12.0 count 1: -t-select-input_quantity-trigger-error : Test Data MessageGlobal, column: Message row: 6'
WebUI.verifyElementText(findTestObject('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/t-select-input_quantity-trigger-error'), 
    findTestData('Data Files/FrontEnd/Test Data Global/Test Data MessageGlobal').getValue('Message', 6))

CustomKeywords.'get.ScreenCapture.getEntirePage'('FrontEnd/FO_CA_CU/TC-Primecash-Corporate User Module-Cheque Book Request/R-52-003-N/Step12.0verify-12.0-count-1.png')
