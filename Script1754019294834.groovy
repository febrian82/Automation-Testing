...
import customKeywords.DesktopScreenshot as DesktopScreenshot

String SSName = 'REG_301'
...
WebUI.click(findTestObject('FrontEnd/Negative Inhouse/to_account'))

CustomKeywords.'keys.CheckorUncheck.CheckUsingCustomKeyword'(findTestObject('FrontEnd/TM_InHouseTransfer/ExchangeRate', 
        [('ExchangeRate') : '1']))

WebUI.setText(findTestObject('Object Repository/FrontEnd/TM_InHouseTransfer/treasury'), findTestData('Negative Inhouse').getValue(
        'TIcket Number', 20), FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'utils.PopupAccountSelector.selectAccountFromPopup'(findTestData('Negative Inhouse').getValue('AccountNo', 
        20))
...
CustomKeywords.'customKeywords.AlertKeywords.verifyAlertText'(findTestData('Negative Inhouse').getValue('ErrorMessage', 
        20))

CustomKeywords.'customKeywords.DesktopScreenshot.captureFullScreen'(SSName, SSName)
